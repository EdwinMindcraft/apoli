...
public record GlobalPowerSet(int order,
    ...
    public static final Codec<GlobalPowerSet> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            CalioCodecHelper.optionalField(CalioCodecHelper.INT, "order", 0).forGetter(GlobalPowerSet::order),
            CalioCodecHelper.optionalField(SerializableDataTypes.ENTITY_TYPE_TAG_LIKE, "entity_types").forGetter(GlobalPowerSet::entityTypes),
